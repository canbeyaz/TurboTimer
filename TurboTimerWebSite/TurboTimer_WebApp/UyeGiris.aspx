<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="UyeGiris.aspx.cs" Inherits="TurboTimer_WebApp.UyeGiris" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="loginPanel">
        ...
        <div class="left">
            ...
            <img src="Assets/Resimler/turbo-hakkinda.jpg" /></div>
         <div class="right">
            <div class="row">
