<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminGiris.aspx.cs" Inherits="TurboTimer_WebApp.AdminPanel.AdminGiris" %>
    ...
    <form id="form1" runat="server">
        <div class="panelContainer">
            ...
            <div class="panelContent">
                ...
                <div class="row">
                    <asp:TextBox ID="tb_sifre" runat="server"  CssClass="inputbox" placeholder="Şifre"></asp:TextBox>
                </div>
                <div>
